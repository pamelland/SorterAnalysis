...
t_start = 60 * 60 * 0;
% t_end   = 60 * 60 * 23.96; % in seconds
t_end   = 60 * 60 * 2; % in seconds
% =========================================================================
...
% option to take a subset of only GT spikes for zenodo spikes --- discards
% background spikes
...
if save_fig
    ...
    pause(1)
    writeFig(gcf, gcf,fig_path,sprintf('Tetrode-%d-mets', tet_list), 'pdf', 300)
end
